...
export const PageTitle = createText(
  "h1",
  "font-display text-lg sm:text-xl font-bold text-stone-900 text-balance",
);

/** Section heading — `<h2>` */
export const SectionTitle = createText(
  "h2",
  "font-display text-base font-semibold text-stone-900 text-balance",
);

/** Column / sub-panel heading — `<h3>` */
export const SubsectionTitle = createText(
  "h3",
  "text-sm font-semibold text-stone-700",
);

/** Card heading (events, alerts) — `<h3>` */
export const CardTitle = createText(
  "h3",
  "font-medium text-stone-900 leading-snug text-pretty",
);

/** Default body text / descriptions — `<p>` */
export const Body = createText("p", "text-sm text-stone-500 text-pretty");

/** Emphasised body (item titles) — `<p>` */
export const BodyMedium = createText(
  "p",
  "text-sm font-medium text-stone-800 text-pretty",
);

/** Small metadata (dates, venues) — `<span>` */
export const Caption = createText("span", "text-xs text-stone-500");

/** Lighter secondary text — `<span>` */
export const Muted = createText("span", "text-xs text-stone-400");

/** Extra-small detail (locations, wind speed) — `<span>` */
export const Tiny = createText("span", "text-[11px] text-stone-400");
...
export const Display = createText(
  "span",
  "text-lg font-bold tabular-nums text-stone-900",
);

/** Secondary display values (temperature low) — `<span>` */
export const DisplaySecondary = createText(
  "span",
  "text-sm tabular-nums text-stone-400",
);
